...
if (!document.getElementById(iframeId)) {
 ...
 navBack.setAttribute('title', 'Перейти назад');
 ...
 navFwd.setAttribute('title', 'Перейти вперед');
 ...
 navUpd.setAttribute('title', 'Обновить страницу');
 ...
 iframeStyle.innerHTML = 'html,body{margin:0;padding:0;font-family:Arial,sans-serif;font-size:14px;letter-spacing:1px;}'
                       ...
                       + 'li{display:inline-block;width:35px;height:35px;margin:5px;margin-right:0;}'
                       ...
                       + '.nav-url{padding-right:35px;line-height:35px;background-color:#2e2f2b;border-radius:' + height + 'px;user-select:none;flex:1;}'
